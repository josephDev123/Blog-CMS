...
import {AddBlog, editBlogPost, allPost, allPostByCategories, allCategoriesPost, GetPostsCreatedByPagination, PostById, getAllPostsOfCurrentAuthUser} from '../controllers/blogPostController.js';
...
blogPostRouter.post('/edit/:id', editBlogPost);
